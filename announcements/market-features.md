# toots pulls live odds now

same `/ask`, same `@Toots`. she just checks the board before she answers now. sports lines, polymarket, kalshi. no new commands.
...
- call anything a "lock"
- tell you how much to bet
- pretend she's a broker

*same toots. now with receipts.*
