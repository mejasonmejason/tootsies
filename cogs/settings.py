    ...
    def help_embed(self) -> discord.Embed:
        ...
        e.add_field(
            ...
            value=(
                ...
                "**yaps**: scheduled at 9am, 12pm, 3pm, 6pm, 10pm ET, chime in up to 20/day\n"
                "**off**: silent on both"
            ),
            inline=False,
        )
        ...
        super().__init__(
            ...
            options=[
                discord.SelectOption(
                    ...
                    description="2 scheduled posts/day, up to 10 chime-ins/day",
                    default=(current_mood == "chill"),
                ),
                discord.SelectOption(
                    label="yaps", value="yaps",
                    description="5 scheduled posts/day, up to 20 chime-ins/day",
