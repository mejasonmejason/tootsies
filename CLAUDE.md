...
| `link_rejected` | claude_client.py (`discourse`, `ask`) | purpose, rejected_count, rejected_urls |
| `link_deduped` | claude_client.py (`discourse`, `ask`) | purpose, deduped_count, deduped_urls |
